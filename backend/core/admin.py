...
from .models import CustomUser, Station, TimeSlot, Booking, Review, Mechanic, PaymentAttempt, Subscription
...
class SubscriptionAdmin(admin.ModelAdmin):
    list_display = [
        'owner', 'plan', 'status', 'bookings_total', 'bookings_remaining',
        'bookings_used', 'commission_owed', 'commission_bookings',
